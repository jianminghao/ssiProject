...
<script type="text/javascript">
	$(function() {
		 ...
		 $('.btn').click(function() {
			var locationPath = "dept.do?method=";
			debugger;
			var opt = $(this).val();
			switch(opt) {
		     case '1':
...
<body>
	<form id="dept" name="dept" method="post" action="">
		...
		<button class="btn" name="insert" value="1">新增</button>
		<button class="btn" name="delete" value="2">删除</button>
		<button class="btn" name="update" value="3">修改</button>
		<button class="btn" name="query" value="4">查询</button>
	</form>
</body>
</html>